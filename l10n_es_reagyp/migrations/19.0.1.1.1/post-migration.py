...
def migrate(cr, version):
    ...
    own therefore leaves it with its English name in every language: on an
    upgraded database the REAGYP purchase position, the group tax and the three
    wrapper taxes all read in English in a Spanish interface, while everything
